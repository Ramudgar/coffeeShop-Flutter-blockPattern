...
PurchasedProductResponse purchasedProductResponseFromJson(String str) =>
    PurchasedProductResponse.fromJson(json.decode(str));

String purchasedProductResponseToJson(PurchasedProductResponse data) =>
...
class PurchasedProductResponse {
  ...
  factory PurchasedProductResponse.fromJson(Map<String, dynamic> json) =>
      PurchasedProductResponse(
        resp: json["resp"],
        msg: json["msg"],
